...
public class HQDao_Part1 extends BaseDAO_Sqlite {
    ...
    /**
     * 方法序号：2_6_1 将商品中关联此税率的商品税率信息置为空
     */
    public String deleteGoodsFiscalNULL(String databaseUrl, Tax tax) {
        String sql = "UPDATE Goods_Info SET Tax_Index='' WHERE Tax_Index=?";
        return Integer.toString(this.saveOrUpdateOrDelete(sql, databaseUrl, tax.getNumber()));
    }
