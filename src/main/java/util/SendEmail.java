...
public class SendEmail {
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "2802180907@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "和桥科技", "UTF-8"));
        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "", "UTF-8"));
        // 4. Subject: 邮件主题
        message.setSubject("税控上位机密码找回", "UTF-8");
        // 5. Content: 邮件正文（可以使用html标签）
        message.setContent("尊敬的用户您好，您的密码已重置，新密码是1234567。感谢您使用和桥产品，和桥用心做好每一件产品。", "text/html;charset=UTF-8");
        // 6. 设置发件时间
